...
function HighlightPill() {
  return (
    <div className="relative w-[179px] h-[67px] flex items-center justify-center">
      <Image
...
export default function HighlightSlider() {
  ...
  return (
    <section className="relative w-full max-h-[888px] 3xl:h-[888px] overflow-hidden cursor-grab">
      ...
      >
        {highlightSlides.map((slide, i) => (
          <SwiperSlide key={i} className="relative">
            {/* Background image */}
            <div className="relative w-full h-screen 2xl:h-[800px] 3xl:h-[888px] max-h-[888px]">
              <Image
                src={slide.bgImage}
                alt={slide.title}
                fill
      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-between container py-120 pointer-events-none">
        {/* Top-left: slide counter */}
        <div className="flex items-center justify-start">
          <div className="w-[56px] h-[56px] rounded-full bg-white/20 flex items-center justify-center text-white">
