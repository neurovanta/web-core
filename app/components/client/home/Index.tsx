  ...
  return (
    <>
      <div style={{ position: "relative" }}>
        {/* Section 1 — Hero */}
        <div style={{ position: "sticky", top: 0, height: "100svh", zIndex: 1 }}>
          <HeroSection />
        </div>

        {/* Section 2 — Wellness Slider 1 */}
        <div style={{ position: "sticky", top: 0, height: "100svh", zIndex: 2 }}>
          <WellnessSlider data={wellnessSliderData} />
        </div>

        {/* Section 3 — Wellness Slider 2 */}
        <div style={{ position: "sticky", top: 0, height: "100svh", zIndex: 3 }}>
          <WellnessSlider
