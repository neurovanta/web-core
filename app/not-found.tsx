...
export default function NotFound() {
  ...
  return (
    <section className="steam-bg relative w-full h-svh flex flex-col items-center justify-end pb-[60px] md:pb-150 overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="container relative z-10 flex justify-center flex-1 mt-[200px] flex-col items-center text-center gap-20 sm:gap-50">
      ...
      <style jsx>{`
        .steam-text {
  animation: haze-breathe 3s ease-in-out 1.2s infinite;
}
